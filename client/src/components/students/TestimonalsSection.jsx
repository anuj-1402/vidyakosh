...
const TestimonalsSection = () => {
  return <div className="pb-14 px-8 md:px-0">
   <h2 className="text-3xl font-medium text-gray-800">Testimonials</h2>
  <p className="md:text-base text-gray-500 mt-3">hear from our students about their experiences with our platform.<br/>How it changed their lives.</p>
  <div className="grid gap-8 mt-14 grid-cols-[repeat(auto-fit,minmax(250px,1fr))]">
    {dummyTestimonial.map((testimonial, index) => (
      ...
      <div className="flex item-center gap-4 px-5 py-5 bg-gray-500/10">
